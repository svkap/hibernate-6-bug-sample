...
public interface ItemRepository extends JpaRepository<ItemEntity, Long> {
  ...
  @Query("""
      ...
      ORDER BY i.createdOn DESC
      """)
  Page<ItemEntity> findItemsJpqlEnumsSpElString(@Param("dateFrom") Instant dateFrom, @Param("dateTo") Instant dateTo,
  ...
  @Query("""
      ...
      ORDER BY i.createdOn DESC
      """)
  Page<ItemEntity> findItemsJpqlEnumsCoalesceString(@Param("dateFrom") Instant dateFrom, @Param("dateTo") Instant dateTo,
      @Param("statuses") List<String> statuses, @Param("types") List<String> types, Pageable pageable);
  ...
  @Query("""
      ...
      ORDER BY i.createdOn DESC
      """)
  Page<ItemEntity> findItemsJpqlEnumsString(@Param("dateFrom") Instant dateFrom, @Param("dateTo") Instant dateTo,
      @Param("statuses") List<String> statuses, @Param("types") List<String> types, Pageable pageable);
